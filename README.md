...
Install the NuGet package called RestLess and one of the extra package (like RestLess.Newtonsoft.Json) into your project.
...
Install *RestLess.Newtonsoft.Json* (if you want to serialize/deserialize using Json.Net)
...
For example, if you want to serialize/deserialize JSON content with [Json.Net](https://github.com/JamesNK/Newtonsoft.Json) you'll have to get the **RestLess.Newtonsoft.Json** NuGet package.
...
The *RestLess* package does not have any dependencies to another third-party library (except *DoLess.UriTemplates*). In order to read/write Json, you need to reference *RestLess.Newtonsoft.Json* for example, but you can also write your own formatting strategies.
